...
class AjaxProductLoaderQueries {
    ...
    public function prepareTempTables ( $term_taxonomy_id, $orderby, $keyword, $attributeFilterObject, $priceFilter ) {
        ...
        $this->storeProductsInTempTable( $term_taxonomy_id, $orderby, $keyword, $priceFilter );
     ...
     */
    private function storeProductsInTempTable ( $term_taxonomy_id, $orderby, $keyword, $priceFilter ) {
        $this->wpdb->get_results('
    ...
    private function storeAttributeValuesInTempTable () {
        $this->wpdb->get_results('
            ...
            SELECT name, slug, filters.attribute_name
    ...
    /**
     * A megadott attribútumos szűrési feltételeket tartalmazó objectum alapján elkészíti az SQL kódot
    ...
    /**
     * A megadott attribútum szűrési feltételek alapján segítkezik a szűrési feltétel SQL kódjának létrehozásában,
     * visszaadja az eseteket.
     * 
     * @param attributeFilterObject - a megadott attribútumokat tartalmazó objectum
     * @return SQL - a szűrő lekérdezés SELECT részébe kerül majd
     */
    ...
    /**
     * A megadott attribútum szűrési feltételek alapján segítkezik a szűrési feltétel SQL kódjának létrehozásában,
     * visszadaja a megfeleő szűrési feltételeket.
     * 
     * @param attributeFilterObject - a megadott attribútumokat tartalmazó objectum
